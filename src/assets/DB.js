...
export let memoryWall = [
  ...
  },
  {
    ...
    about: `
    מלחמת יום הכיפורים פרצה ביום הכיפורים ה'תשל"ד, 6 באוקטובר 1973, בהתקפת קואליציה של צבאות
     מדינות ערביות נגד ישראל, בהובלתן של סוריה ומצרים, שנתמכו על ידי חילות משלוח
     מארצות ערב, בעיקר מעיראק ומירדן. חילופי אש נמשכו עד 26 באוקטובר. במלחמה
     ספג צה"ל אבדות גדולות יותר מ2000 חיילים נהרגו במלחמה. יהי זכרם ברוך.`,
    ratingTypes: {
    ...
    highlightsNews: [
      {
        ...
        date: "2022-03-03",
        text: `"אני לא מגדיר את עצמי הלום קרב, אבל אני חושב שכל יום המלחמה באה לביקור", 
        כך מתאר יעקב חורין, שהיה באוקטובר 1973 קצין מילואים צעיר בשריון, את הסיבה שבחר אחרי כמעט יובל שנים, לחטט בפצעים של מה שלא הצליח לשכוח. מעבר להיותה הטראומה הקולקטיבית הגדולה ביותר בתולדות מדינת ישראל, מלחמת יום הכיפורים היא גם אירוע ששינה את חייהם האישיים של עשרות אלפי הלוחמים
         שלקחו בה חלק. תוך כדי שבנו את חייהם הבוגרים, רבים מהם בחרו להדחיק את הזיכרונות ממה שעברו באותם 19 ימי לחימה ונמנעו מלדבר על כך במשך 48 שנים – על אף שהמשקעים נותרו בנפשם.
        רק היום, כשהם כבר חובקים
         נכדים, הם מעזים לספר על אותה התקופה, שבה חוו בגוף ראשון את מוראות המלחמה, איבדו את חבריהם לנשק, נחשפו לזוועות שדה הקרב והרגישו
         שהם נושאים על כתפיהם הצרות את האחריות להישרדותה של מדינת היהודים. בעוד שהארכיונים עמוסים בחומרים שתיעדו את זיכרונותיהם של מנהיגי 
        המדינה באותו הזמן, הקצינים הבכירים וגיבורי המלחמה המעוטרים – חוויותיהם של רבים מהלוחמים הפשוטים מתחילות רק עכשיו לצאת לאור והצלקות שהסתירו נחשפות.
...
`,
    ...
    sliderUpdates: [
      ...
      },
      {
        ...
        text: "מלחמת יום היכפורים",
      },
      {
        id: "4",
        imagePath:
          "https://th.bing.com/th/id/R.cf47cc7c1bd57b6a27927337c3aa6750?rik=WNwu%2b2EK5OtHuQ&pid=ImgRaw&r=0",
        text: "בחזית הלחימה",
      },
      {
        id: "5",
